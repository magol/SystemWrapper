...
namespace SystemWrapper.IO
{
    ...
    public interface IFileStreamWrap : IStreamWrap
    {
    	...
    	void Initialize(ISafeFileHandleWrap handle, FileAccess access);
    	...
    	void Initialize(ISafeFileHandleWrap handle, FileAccess access, int bufferSize);
    	...
    	void Initialize(ISafeFileHandleWrap handle, FileAccess access, int bufferSize, bool isAsync);
