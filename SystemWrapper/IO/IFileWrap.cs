...
namespace SystemWrapper.IO
{
	...
	public interface IFileWrap
	{
        ...
        IFileStreamWrap Create(string path);
        /// <summary>
        ...
        IFileStreamWrap Create(string path, int bufferSize);
        /// <summary>
        ...
        IFileStreamWrap Create(string path, int bufferSize, FileOptions options);
        /// <summary>
        ...
        IFileStreamWrap Create(string path, int bufferSize, FileOptions options, IFileSecurityWrap fileSecurity);
        /// <summary>
        /// Creates or opens a file for writing UTF-8 encoded text. 
        /// </summary>
        /// <param name="path">The file to be opened for writing. </param>
        /// <returns>A IStreamWriterWrap that writes to the specified file using UTF-8 encoding. </returns>
        IStreamWriterWrap CreateText(string path);
        /// <summary>
        ...
        IFileSecurityWrap GetAccessControl(string path);
        /// <summary>
        /// Gets a IFileSecurityWrap object that encapsulates the access control list (ACL) entries for a specified file.
        /// </summary>
        /// <param name="path">The path to a file containing a FileSecurity object that describes the file's access control list (ACL) information.</param>
        ...
        /// <returns>A IFileSecurityWrap object that encapsulates the access control rules for the file described by the path parameter.</returns>
        IFileSecurityWrap GetAccessControl(string path, AccessControlSections includeSections);
        /// <summary>
        ...
        void SetAccessControl(string path, IFileSecurityWrap fileSecurity);
        /// <summary>
